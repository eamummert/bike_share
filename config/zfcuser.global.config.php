...
$settings = [
     ...
     */
    'user_entity_class' => 'Libs\Entity\User',
     ...
     */
    'default_user_state' => Roles::ROLE_GUEST,
     ...
     */
    'allowed_login_states' => [Roles::ROLE_GUEST, Roles::ROLE_VIEW, Roles::ROLE_ADMIN],
